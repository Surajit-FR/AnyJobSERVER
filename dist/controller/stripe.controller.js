...
const attatchPaymentMethod = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const attach = yield stripe.paymentMethods.attach(paymentMethodId, { customer: customer.id });
...
const createConnectedAccountAndRedirect = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const additionalInfo = yield userAdditionalInfo_model_1.default.findOne({ userId: user._id });
