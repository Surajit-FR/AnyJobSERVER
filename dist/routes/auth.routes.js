...
router
    ...
    .post(rateLimiter_middleware_1.rateLimiter, [userAuth_1.VerifyJWTToken], auth_controller_1.saveFcmToken);
// Logout
router.route("/logout").post(rateLimiter_middleware_1.rateLimiter, [userAuth_1.VerifyJWTToken], auth_controller_1.logoutUser);
router
    .route("/add-associate")
    .post(rateLimiter_middleware_1.rateLimiter, [userAuth_1.VerifyJWTToken], (0, userAuth_1.verifyUserType)(["ServiceProvider", "TeamLead"]), auth_controller_1.addAssociate);
router
...
router
    .route("/delete-user")
    .delete([userAuth_1.VerifyJWTToken], (0, userAuth_1.verifyUserType)(["SuperAdmin"]), auth_controller_1.deleteUser);
