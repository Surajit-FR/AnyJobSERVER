...
exports.verifyOTP = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const otpEntry = yield otp_model_1.default.findOne({ [queryField]: formattedIdentifier });
    ...
    if (!otpEntry || otpEntry.expiredAt < new Date()) {
        ...
        return (0, response_1.sendSuccessResponse)(res, 400, "Invalid or expired OTP");
    }
    if (!isOtpValid) {
    ...
    switch (purpose) {
        case "login": {
            ...
            const companyDetails = yield userAdditionalInfo_model_1.default.findOne({ userId: serviceProviderInfo === null || serviceProviderInfo === void 0 ? void 0 : serviceProviderInfo.serviceProviderId }).select('companyName companyIntroduction businessName');
